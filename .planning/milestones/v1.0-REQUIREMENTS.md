...
- [x] **TEST-01**: Mindestens 3 FastAPI-Routen mit echtem TestClient getestet (GET /api/calls, GET /api/pbx/status, POST /api/contacts)
- [x] **TEST-02**: MQTT-Reconnect-Szenarien getestet: Broker-Neustart, Publish-while-offline, Connection-Drop
- [x] **TEST-03**: Call-Aggregation Edge Cases: DISCONNECT ohne RING, CONNECT ohne DISCONNECT, Orphan-Calls
